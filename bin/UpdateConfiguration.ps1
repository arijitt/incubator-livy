...
if (!$FilePath) { throw [System.ArgumentException] "Configuration file path is not specified with --FilePath."}
if (!$ConfigurationKeys) { throw [System.ArgumentException] "Configuration key is not specified with --ConfigurationKeys."}
if (!$ConfigurationValues) { throw [System.ArgumentException] "Configuration value is not specified with --ConfigurationValues."}
